...
The [MultiCaRe dataset](https://zenodo.org/records/14994046) is an open-source clinical case dataset for medical image classification and multimodal AI applications. Some facts about it:
